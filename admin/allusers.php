     ...
     <table class="highlight striped">
        <thead>
          <tr>
              ...
              <th data-field="exactlocation">exactlocation</th>
        ...
        <tbody>
          ...
          include '../db.php';
                  ...
                  //get users
                  $queryuser = "SELECT id, email, firstname, lastname, address, exactlocation, county  FROM users WHERE role = 'client'";
                  ...
                  if ($resultuser->num_rows > 0) {
                    ...
                    while($rowuser = $resultuser->fetch_assoc()) {
                      ...
                      $email = $rowuser['email'];
                      $exactlocation = $rowuser['exactlocation'];
                      $county = $rowuser['county'];
