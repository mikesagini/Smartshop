...
<div id="test2" class="col s12 left-align">
    ...
    <form class="col s12" method="POST" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="input-field col s6">
          <select class="icons" name="county">
      <option value=""  disabled selected>Choose your county</option>
      <option value="Morocco">Tharaka Nithi</option>
      <option value="Egypt">Embu</option>
      <option value="Algeria">Meru</option>
    </select>
    <label>County</label>
        </div>
        ...
        <div class="input-field col s6">
          ...
          <label for="icon_prefix">ConfirmPassword</label>
        </div>
        ...
        <div class="input-field col s6 meh">
          ...
          <label for="icon_prefix">Address</label>
           ...
           <?php require 'includes/signupconfirmation.php';?>
            ...
            <p>By Registering, you agree that you've conset on how we operate and ready to do business with us</p>
      </div>
    </form>
  </div>
     </div>
